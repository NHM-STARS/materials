...
-   **geoms** - geometric objects
    ...
    -   `geom_point()`, `geom_bar()`, `geom`_density()`, `geom_line()`, `geom_area()`
...
```{r, fig.height = 4}
climate <- read.csv("https://raw.githubusercontent.com/karthikram/ggplot-lecture/master/climate.csv", header = T)
...
ggsave(myplt, filename = "myplot.png", width = 6, height = 4)
```
